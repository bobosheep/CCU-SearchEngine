    ...
    function SearchResultComponent(http) {
        ...
        this.getSearch = function () {
            if (_this.query.length > 0) {
                ...
                _this.http.post("http://localhost:9200/clothes/_search", _this.queryBody, _this.httpOptions)
